...
public partial class usercontrols_Dashboard_PostDatedChequePaid : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        BindPostDatedChequePaidreminder();
    }
    private void BindPostDatedChequePaidreminder()
    {
        ...
        html.Append("</table>");
        ltPostDatedChequePaid.Text = html.ToString();
    }
}
