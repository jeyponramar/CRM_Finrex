...
{
    private bool _IsColumnChart = false;
    ...
    public void BindChart()
    {
        ...
        Script.Append(@"var chart = new google.visualization.LineChart(document.getElementById('" + chartId + "'));" + Environment.NewLine);
        ...
        ltLineChart.Text = html.ToString();
    }
