...
public partial class AreaChart : System.Web.UI.UserControl
{
    ...
    {
        string query = "select * from tbl_report where REPLACE(report_reportname,' ','')='" + Module.Trim().Replace(" ", "") + "'";
    ...
    public void BindChart()
    {
        ...
        @" var data = google.visualization.arrayToDataTable([" +
                    getArrayValueScript(arrColumnsHeader));
        Script.Append(",");
        string Columndata = "";
        for (int i = 0; i < _Data.Rows.Count; i++)
        {
            string scriptdata = getColumnDataScript((DataRow)_Data.Rows[i]);
        ...
        Script.Append(@"var chart = new google.visualization.AreaChart(document.getElementById('" + chartId + "'));" + Environment.NewLine);
        ...
        ltAreaChart.Text = html.ToString();
    }
