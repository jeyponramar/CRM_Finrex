...
public partial class Campaign_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_campaign", "campaignid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
			...
			gblData.FillDropdown(ddlcampaigntypeid, "tbl_campaigntype", "campaigntype_campaigntype", "campaigntype_campaigntypeid", "", "campaigntype_campaigntype");
			//FillDropDown_END
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Campaign";
        }
        else
        {
            lblPageTitle.Text = "Edit Campaign";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
        {
            Response.Redirect("~/Campaign/view.aspx");
        }
    }
