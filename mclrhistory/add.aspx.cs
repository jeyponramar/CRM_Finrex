...
public partial class MCLRHistory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_mclrhistory", "mclrhistoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add MCLR History";
        }
        else
        {
            lblPageTitle.Text = "Edit MCLR History";
        }
