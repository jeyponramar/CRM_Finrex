...
public partial class Webinar_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_webinar", "webinarid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Webinar";
        }
        else
        {
            lblPageTitle.Text = "Edit Webinar";
        }
