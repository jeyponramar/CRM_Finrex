...
public partial class FinstationNotificationType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_finstationnotificationtype", "finstationnotificationtypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Finstation Notification Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Finstation Notification Type";
        }
