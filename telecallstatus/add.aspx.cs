...
public partial class TeleCallStatus_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_telecallstatus", "telecallstatusid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Tele Call Status";
        }
        else
        {
            lblPageTitle.Text = "Edit Tele Call Status";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/TeleCallStatus/view.aspx");
    }
