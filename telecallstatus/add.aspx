 ...
 CodeFile="add.aspx.cs" Inherits="TeleCallStatus_add" EnableEventValidation="false" ValidateRequest="false"%>
								...
								<tr>
									<td width='50%' class='valign'>
										...
										<tr>
											...
											<td ti='0'><asp:TextBox ID="txtstatus"  IsUnique="true" MaxLength="100" runat="server"  dcn="telecallstatus_status" CssClass="textbox"></asp:TextBox>
