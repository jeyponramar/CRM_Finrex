...
public partial class LiverateHistory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_liveratehistory", "liveratehistoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Liverate History";
        }
        else
        {
            lblPageTitle.Text = "Edit Liverate History";
        }
