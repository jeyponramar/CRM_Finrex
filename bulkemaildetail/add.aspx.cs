...
public partial class BulkEmailDetail_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bulkemaildetail", "bulkemaildetailid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bulk Email Detail";
        }
        else
        {
            lblPageTitle.Text = "Edit Bulk Email Detail";
        }
