...
public partial class Exposure_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_exposure", "exposureid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Exposure";
        }
        else
        {
            lblPageTitle.Text = "Edit Exposure";
        }
