...
public partial class Designation_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_designation", "designationid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Designation";
        }
        else
        {
            lblPageTitle.Text = "Edit Designation";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/Designation/view.aspx");
		}
    }
