...
public partial class TaxType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_taxtype", "taxtypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Tax Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Tax Type";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/TaxType/view.aspx");
    }
