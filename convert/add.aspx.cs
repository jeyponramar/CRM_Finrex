...
public partial class Convert_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_convert", "convertid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Convert";
        }
        else
        {
            lblPageTitle.Text = "Edit Convert";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/Convert/view.aspx");
		}
    }
