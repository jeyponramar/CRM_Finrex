...
public partial class BankAuditYearlyBankingCost_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankaudityearlybankingcost", "bankaudityearlybankingcostid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Yearly Banking Cost";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Yearly Banking Cost";
        }
