...
public partial class NotificationRules_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_notificationrules", "notificationrulesid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Notification Rules";
        }
        else
        {
            lblPageTitle.Text = "Edit Notification Rules";
        }
