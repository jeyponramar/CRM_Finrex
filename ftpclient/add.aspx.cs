...
public partial class FTPClient_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_ftpclient", "ftpclientid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add FTP Client";
        }
        else
        {
            lblPageTitle.Text = "Edit FTP Client";
        }
    ...
    private int SaveData(bool isclose)
    {
        ...
        if (id > 0)
        {
			...
			mcftpclientftpcurrencies.Save(id);
			//SaveSubTable_END
            //SaveFile_START
			//SaveFile_END
