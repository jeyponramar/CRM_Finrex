...
public partial class ExportFactoringEnquiry_add : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Export Factoring Enquiry";
        }
        else
        {
            lblPageTitle.Text = "Edit Export Factoring Enquiry";
        }
