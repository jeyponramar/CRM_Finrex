...
public partial class TypeofBuyersCredit_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_typeofbuyerscredit", "typeofbuyerscreditid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Type of Buyers Credit";
        }
        else
        {
            lblPageTitle.Text = "Edit Type of Buyers Credit";
        }
