...
public partial class BusinessType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_businesstype", "businesstypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Business Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Business Type";
        }
