...
public partial class EmailFormat_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_emailformat", "emailformatid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                txtemailformatname.Enabled = false;
                //Populate_START
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Email Format";
        }
        else
        {
            lblPageTitle.Text = "Edit Email Format";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/EmailFormat/view.aspx");
    }
