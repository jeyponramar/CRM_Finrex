 ...
 CodeFile="add.aspx.cs" Inherits="ExportLCDiscountingEnquiry_add" EnableEventValidation="false" ValidateRequest="false"%>
						...
						<asp:RequiredFieldValidator ID="rfv8" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Required Importer Name (Supplier)" ValidationGroup="vg" ControlToValidate="txtimporternamesupplier"></asp:RequiredFieldValidator></td>
									...
									<td width='50%' class='valign'>
										...
										<tr>
											...
											<td ti='3'><asp:TextBox ID="txttransactionamountwithcurrency"  dcn="exportlcdiscountingenquiry_transactionamountwithcurrency" runat="server" MaxLength="15" CssClass="mbox val-dbl" Text="0"></asp:TextBox>
