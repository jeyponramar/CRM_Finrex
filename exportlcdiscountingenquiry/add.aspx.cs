...
public partial class ExportLCDiscountingEnquiry_add : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Export LC Discounting Enquiry";
        }
        else
        {
            lblPageTitle.Text = "Edit Export LC Discounting Enquiry";
        }
