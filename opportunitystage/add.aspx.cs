...
public partial class OpportunityStage_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_opportunitystage", "opportunitystageid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Opportunity Stage";
        }
        else
        {
            lblPageTitle.Text = "Edit Opportunity Stage";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if(SaveData(false) > 0)
        {
			Response.Redirect("~/OpportunityStage/view.aspx");
		}
    }
