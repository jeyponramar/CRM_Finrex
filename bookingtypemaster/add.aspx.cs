...
public partial class BookingTypeMaster_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bookingtypemaster", "bookingtypemasterid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Booking Type Master";
        }
        else
        {
            lblPageTitle.Text = "Edit Booking Type Master";
        }
