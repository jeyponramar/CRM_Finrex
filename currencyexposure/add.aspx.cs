...
public partial class CurrencyExposure_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_currencyexposure", "currencyexposureid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Currency Exposure";
        }
        else
        {
            lblPageTitle.Text = "Edit Currency Exposure";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if(SaveData(false) > 0)
        {
			Response.Redirect("~/CurrencyExposure/view.aspx");
		}
    }
