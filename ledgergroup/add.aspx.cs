...
public partial class LedgerGroup_add : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Ledger Group";
        }
        else
        {
            lblPageTitle.Text = "Edit Ledger Group";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/LedgerGroup/view.aspx");
    }
