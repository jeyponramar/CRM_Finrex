...
public partial class FollowupStatus_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_followupstatus", "followupstatusid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Followup Status";
        }
        else
        {
            lblPageTitle.Text = "Edit Followup Status";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/FollowupStatus/view.aspx");
		}
    }
