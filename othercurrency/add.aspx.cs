...
public partial class OtherCurrency_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_othercurrency", "othercurrencyid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Other Currency";
        }
        else
        {
            lblPageTitle.Text = "Edit Other Currency";
        }
