...
public partial class Priority_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_priority", "priorityid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Priority";
        }
        else
        {
            lblPageTitle.Text = "Edit Priority";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/Priority/view.aspx");
		}
    }
