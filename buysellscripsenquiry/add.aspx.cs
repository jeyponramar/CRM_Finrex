...
public partial class BuySellScripsEnquiry_add : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Buy Sell Scrips Enquiry";
        }
        else
        {
            lblPageTitle.Text = "Edit Buy Sell Scrips Enquiry";
        }
