...
public partial class BankAuditCustomLabel_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditcustomlabel", "bankauditcustomlabelid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Custom Label";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Custom Label";
        }
