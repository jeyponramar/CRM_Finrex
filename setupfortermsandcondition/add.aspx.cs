...
public partial class SetUpForTermsAndCondition_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_setupfortermsandcondition", "setupfortermsandconditionid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
			...
			gblData.FillDropdown(ddltermsandconditiontypeid, "tbl_termsandconditiontype", "termsandconditiontype_termsandconditiontype", "termsandconditiontype_termsandconditiontypeid", "", "termsandconditiontype_termsandconditiontype");
			//FillDropDown_END
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Set Up For Terms And Condition";
        }
        else
        {
            lblPageTitle.Text = "Edit Set Up For Terms And Condition";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/SetUpForTermsAndCondition/view.aspx");
		}
    }
