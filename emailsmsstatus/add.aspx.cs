...
public partial class EmailSMSStatus_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_emailsmsstatus", "emailsmsstatusid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Email SMS Status";
        }
        else
        {
            lblPageTitle.Text = "Edit Email SMS Status";
        }
