...
public partial class AdvisoryFrequencyMaster_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_advisoryfrequencymaster", "advisoryfrequencymasterid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Advisory Frequency Master";
        }
        else
        {
            lblPageTitle.Text = "Edit Advisory Frequency Master";
        }
