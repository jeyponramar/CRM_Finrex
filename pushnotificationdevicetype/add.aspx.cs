...
public partial class PushNotificationDeviceType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_pushnotificationdevicetype", "pushnotificationdevicetypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Push Notification Device Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Push Notification Device Type";
        }
