...
public partial class Holiday_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_holiday", "holidayid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Holiday";
        }
        else
        {
            lblPageTitle.Text = "Edit Holiday";
        }
