 ...
 CodeFile="add.aspx.cs" Inherits="Holiday_add" EnableEventValidation="false" ValidateRequest="false"%>
					...
					<tr>
								...
								<tr>
									<td width='50%' class='valign'>
										...
										<tr>
											...
											<td ti='0'><asp:DropDownList ID="ddlcurrencyid"  dcn="holiday_currencyid"  search='true' runat="server" m="currency" cn="currency" CssClass="ddl"></asp:DropDownList>
						<asp:RequiredFieldValidator ID="rfv0" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Required Currency" ValidationGroup="vg" ControlToValidate="ddlcurrencyid"  InitialValue="0"></asp:RequiredFieldValidator></td>
										...
										<tr>
											...
											<td ti='1'><asp:TextBox ID="txtdate"  dcn="holiday_date" runat="server" autocomplete="off" MaxLength="11" Format="Date" CssClass="textbox datepicker"></asp:TextBox>
						<asp:RequiredFieldValidator ID="rfv1" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Required Date" ValidationGroup="vg" ControlToValidate="txtdate"></asp:RequiredFieldValidator></td>
										...
										<tr>
											...
											<td ti='2'><asp:TextBox ID="txtdescription"  search='true'  MaxLength="100" runat="server"  dcn="holiday_description" CssClass="textbox"></asp:TextBox></td>
										</tr>
										</table>
									</td>
									<td width='50%' class='valign'>
