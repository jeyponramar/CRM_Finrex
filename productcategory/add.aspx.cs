...
{
    GlobalData gblData = new GlobalData("tbl_productcategory", "productcategoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Product Category";
        }
        else
        {
            lblPageTitle.Text = "Edit Product Category";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/ProductCategory/view.aspx");
    }
