...
public partial class OpportunityStatus_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_opportunitystatus", "opportunitystatusid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Opportunity Status";
        }
        else
        {
            lblPageTitle.Text = "Edit Opportunity Status";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/OpportunityStatus/view.aspx");
    }
