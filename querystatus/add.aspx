 ...
 CodeFile="add.aspx.cs" Inherits="QueryStatus_add" EnableEventValidation="false" ValidateRequest="false"%>
								...
								<tr>
									<td width='50%' class='valign'>
										...
										<tr>
											...
											<td ti='0'><asp:TextBox ID="txtstatus"  IsUnique="true"  search='true'  MaxLength="100" runat="server"  dcn="querystatus_status" CssClass="textbox"></asp:TextBox>
