...
public partial class QueryStatus_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_querystatus", "querystatusid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Query Status";
        }
        else
        {
            lblPageTitle.Text = "Edit Query Status";
        }
