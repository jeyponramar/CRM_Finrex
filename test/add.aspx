 ...
 CodeFile="add.aspx.cs" Inherits="test_add" EnableEventValidation="false" ValidateRequest="false"%>
								...
								<tr>
									<td width='50%' class='valign'>
										...
										<tr>
											...
											<td><asp:TextBox ID="txttestname" MaxLength="100" runat="server"  dcn="test_testname" CssClass="textbox"></asp:TextBox></td>
										</tr>
										</table>
									</td>
									<td width='50%' class='valign'>
