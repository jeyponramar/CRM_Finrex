...
public partial class test_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_test", "testid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add test";
        }
        else
        {
            lblPageTitle.Text = "Edit test";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/test/view.aspx");
		}
    }
