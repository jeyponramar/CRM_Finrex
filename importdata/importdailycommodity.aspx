<%@ Page Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="importdailycommodity.aspx.cs" 
Inherits="importdata_importdailycommodity" Title="Excel Import - Daily Commodity" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server" Text="Data Import - Daily Commodity"/>
        </td>
     </tr>
     <tr>
