<%@ Page Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="import-mclr.aspx.cs" 
Inherits="importdata_importmclr" Title="Excel Import - MCLR" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server" Text="Data Import - MCLR"/>
        </td>
     </tr>
     <tr>
