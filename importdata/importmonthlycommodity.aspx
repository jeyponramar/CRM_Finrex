<%@ Page Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="importmonthlycommodity.aspx.cs" 
Inherits="importdata_importmonthlycommodity" Title="Excel Import - Daily Commodity" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server" Text="Data Import - Monthly Commodity"/>
        </td>
     </tr>
     <tr>
     ...
     <tr>
        <td colspan="2">
            <table width="100%" class="form">
                ...
                <tr>
                    <td>USD Closing Rate</td>
                    <td><asp:TextBox ID="txtusdclosingrate" runat="server" CssClass="val-dbl mbox"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>RBI Ref Rate</td>
                    <td><asp:TextBox ID="txtrbirefrate" runat="server" CssClass="val-dbl mbox"></asp:TextBox></td>
                </tr>
                <tr><td>&nbsp;</td></tr>
                <tr>
                    <td></td>
