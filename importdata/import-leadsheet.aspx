<%@ Page Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="import-leadsheet.aspx.cs" Inherits="importdata_importleadsheet" Title="Excel Import - Lead Sheet" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server" Text="Data Import - Enquiry"/>
        </td>
     </tr>
     <tr>
