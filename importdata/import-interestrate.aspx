<%@ Page Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="import-interestrate.aspx.cs" 
Inherits="importdata_import_interestrate" Title="Excel Import - Interest Rate" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server" Text="Data Import - Interest Rate"/>
        </td>
     </tr>
     <tr>
        ...
        <td width="50%" valign="top">
            <table width="100%" class="form">
                ...
                <tr>
                    <td>
                        <table>
                            <tr><td>Type can be as follows</td></tr>
                            <tr><td><asp:Literal ID="ltinteresttype" runat="server"></asp:Literal></td></tr>
                        </table>
                    </td>
                </tr>
