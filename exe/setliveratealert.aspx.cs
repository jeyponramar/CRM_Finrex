...
public partial class exe_setliveratealert : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            lnkback.NavigateUrl = "default.aspx?sid=" + Common.GetQueryString("sid");
    ...
    {
        int clientId = Finstation.ClientIdBySessionId;
    ...
    private int SaveData(bool isclose)
    {
        ...
        int id = 0;
        int clientUserId = Finstation.ClientUserIdBySessionId;
        int clientId = Finstation.ClientIdBySessionId;
