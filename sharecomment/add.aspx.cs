...
public partial class ShareComment_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_sharecomment", "sharecommentid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Share Comment";
        }
        else
        {
            lblPageTitle.Text = "Edit Share Comment";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/ShareComment/view.aspx");
    }
