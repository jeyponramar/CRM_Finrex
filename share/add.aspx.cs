...
public partial class share_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_share", "shareid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add share";
        }
        else
        {
            lblPageTitle.Text = "Edit share";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/share/view.aspx");
    }
