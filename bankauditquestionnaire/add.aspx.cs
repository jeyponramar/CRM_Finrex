...
public partial class BankAuditQuestionnaire_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditquestionnaire", "bankauditquestionnaireid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Questionnaire";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Questionnaire";
        }
