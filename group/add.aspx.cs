...
public partial class Group_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_group", "groupid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Group";
        }
        else
        {
            lblPageTitle.Text = "Edit Group";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/Group/view.aspx");
		}
    }
