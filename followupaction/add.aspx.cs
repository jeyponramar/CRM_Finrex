...
public partial class FollowupAction_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_followupaction", "followupactionid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Followup Action";
        }
        else
        {
            lblPageTitle.Text = "Edit Followup Action";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/FollowupAction/view.aspx");
		}
    }
