...
public partial class TeleCallHistory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_telecallhistory", "telecallhistoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Tele Call History";
        }
        else
        {
            lblPageTitle.Text = "Edit Tele Call History";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/TeleCallHistory/view.aspx");
    }
