...
public partial class BankAudit_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankaudit", "bankauditid");
    
    protected void Page_Load(object sender, EventArgs e)
    {
        Response.Redirect("~/auditadvisor/addbankaudit.aspx?id=" + Request.QueryString["id"]);
        if (!IsPostBack)
        {
            //FillDropDown_START
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit";
        }
