...
public partial class AccountVoucherType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_accountvouchertype", "accountvouchertypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Account Voucher Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Account Voucher Type";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/AccountVoucherType/view.aspx");
    }
