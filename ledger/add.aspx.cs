...
public partial class Ledger_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_ledger", "ledgerid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Ledger";
        }
        else
        {
            lblPageTitle.Text = "Edit Ledger";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/Ledger/view.aspx");
    }
