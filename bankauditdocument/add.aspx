 ...
 CodeFile="add.aspx.cs" Inherits="BankAuditDocument_add" EnableEventValidation="false" ValidateRequest="false"%>
							...
							<table width='100%' cellpadding='3' cellspacing='5'>
								<tr>
									<td width='50%' class='valign'>
										...
										<tr>
											<td class="label">File Names</td>
											<td ti='0'><asp:TextBox ID="txtfilenames"  MaxLength="0" runat="server"  dcn="bankauditdocument_filenames" CssClass="textbox"></asp:TextBox></td>
										</tr>
										</table>
									</td>
									<td width='50%' class='valign'>
