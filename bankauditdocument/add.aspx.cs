...
public partial class BankAuditDocument_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditdocument", "bankauditdocumentid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Document";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Document";
        }
