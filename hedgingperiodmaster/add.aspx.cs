...
public partial class HedgingPeriodMaster_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_hedgingperiodmaster", "hedgingperiodmasterid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Hedging Period Master";
        }
        else
        {
            lblPageTitle.Text = "Edit Hedging Period Master";
        }
