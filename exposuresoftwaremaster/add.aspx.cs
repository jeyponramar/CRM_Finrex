...
public partial class ExposureSoftwareMaster_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_exposuresoftwaremaster", "exposuresoftwaremasterid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Exposure Software Master";
        }
        else
        {
            lblPageTitle.Text = "Edit Exposure Software Master";
        }
