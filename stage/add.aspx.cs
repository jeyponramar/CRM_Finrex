...
public partial class Stage_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_stage", "stageid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Stage";
        }
        else
        {
            lblPageTitle.Text = "Edit Stage";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if(SaveData(false) > 0)
        {
			Response.Redirect("~/Stage/view.aspx");
		}
    }
