...
public partial class CommunicationSource_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_communicationsource", "communicationsourceid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Communication Source";
        }
        else
        {
            lblPageTitle.Text = "Edit Communication Source";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
        {
            Response.Redirect("~/CommunicationSource/view.aspx");
        }
    }
