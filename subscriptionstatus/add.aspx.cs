...
public partial class SubscriptionStatus_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_subscriptionstatus", "subscriptionstatusid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Subscription Status";
        }
        else
        {
            lblPageTitle.Text = "Edit Subscription Status";
        }
