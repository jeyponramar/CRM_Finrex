...
public partial class BulkSMSTemplate_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bulksmstemplate", "bulksmstemplateid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bulk SMS Template";
        }
        else
        {
            lblPageTitle.Text = "Edit Bulk SMS Template";
        }
