 ...
 CodeFile="add.aspx.cs" Inherits="ARRMaster_add" EnableEventValidation="false" ValidateRequest="false"%>
								...
								<tr>
									<td width='50%' class='valign'>
										...
										<tr>
											...
											<td ti='0'><asp:TextBox ID="txtname"  IsUnique="true"  search='true'  MaxLength="100" runat="server"  dcn="arrmaster_name" CssClass="textbox"></asp:TextBox>
