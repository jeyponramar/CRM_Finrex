...
public partial class ARRMaster_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_arrmaster", "arrmasterid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add ARR Master";
        }
        else
        {
            lblPageTitle.Text = "Edit ARR Master";
        }
