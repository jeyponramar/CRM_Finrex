...
public partial class ExposureCurrencyMaster_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_exposurecurrencymaster", "exposurecurrencymasterid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Exposure Currency Master";
        }
        else
        {
            lblPageTitle.Text = "Edit Exposure Currency Master";
        }
