...
public partial class GoodsType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_goodstype", "goodstypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Goods Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Goods Type";
        }
