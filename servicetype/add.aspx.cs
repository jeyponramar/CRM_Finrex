...
public partial class ServiceType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_servicetype", "servicetypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Service Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Service Type";
        }
