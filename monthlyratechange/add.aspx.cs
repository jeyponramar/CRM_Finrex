...
public partial class MonthlyRateChange_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_monthlyratechange", "monthlyratechangeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Monthly Rate Change";
        }
        else
        {
            lblPageTitle.Text = "Edit Monthly Rate Change";
        }
