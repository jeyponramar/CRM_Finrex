...
public partial class KYCBankDetail_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_clientkycbankdetail", "clientkycbankdetailid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add KYC Bank Detail";
        }
        else
        {
            lblPageTitle.Text = "Edit Client Bank Detail";
        }
