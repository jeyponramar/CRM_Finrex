...
public partial class QueryType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_querytype", "querytypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Query Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Query Type";
        }
