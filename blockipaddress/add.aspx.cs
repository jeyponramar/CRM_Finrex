...
public partial class BlockIPAddress_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_blockipaddress", "blockipaddressid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Block IP Address";
        }
        else
        {
            lblPageTitle.Text = "Edit Block IP Address";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/BlockIPAddress/view.aspx");
    }
