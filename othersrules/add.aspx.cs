...
public partial class OthersRules_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_othersrules", "othersrulesid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Others Rules";
        }
        else
        {
            lblPageTitle.Text = "Edit Others Rules";
        }
