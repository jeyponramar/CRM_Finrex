...
public partial class BankAuditCurrency_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditcurrency", "bankauditcurrencyid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Currency";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Currency";
        }
