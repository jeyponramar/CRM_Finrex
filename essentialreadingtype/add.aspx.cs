...
public partial class EssentialReadingType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_essentialreadingtype", "essentialreadingtypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Essential Reading Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Essential Reading Type";
        }
