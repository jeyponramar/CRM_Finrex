...
public partial class ForwardLimitMaster_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_forwardlimitmaster", "forwardlimitmasterid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Forward Limit Master";
        }
        else
        {
            lblPageTitle.Text = "Edit Forward Limit Master";
        }
