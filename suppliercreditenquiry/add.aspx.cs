...
public partial class SupplierCreditEnquiry_add : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Supplier Credit Enquiry";
        }
        else
        {
            lblPageTitle.Text = "Edit Supplier Credit Enquiry";
        }
