...
using WebComponent;
public partial class tradefinanceenquiry_export_factor : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_exportfactoringenquiry", "exportfactoringenquiryid");
    ...
    {
        string query = "";
        query = @"select * from tbl_exportfactoringenquiry
        ...
        query += " where exportfactoringenquiry_exportfactoringenquiryid=" + id;
        DataRow dr = DbTable.ExecuteSelectRow(query);
        string body = Common.GetFormattedSettingForEmail("tradefinanceenquiry-export-factor", dr);
        //Response.Write(body);
        //Response.End();
        BulkEmail.SendMail_Alert("tradefinance@finrex.in", "", "", "Export Finance - Export Factoring Enquiry", body, "");
    }
