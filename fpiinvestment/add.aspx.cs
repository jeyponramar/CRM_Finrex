...
public partial class FPIInvestment_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_fpiinvestment", "fpiinvestmentid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add FPI Investment";
        }
        else
        {
            lblPageTitle.Text = "Edit FPI Investment";
        }
