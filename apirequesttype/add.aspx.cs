...
public partial class APIRequestType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_apirequesttype", "apirequesttypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add API Request Type";
        }
        else
        {
            lblPageTitle.Text = "Edit API Request Type";
        }
