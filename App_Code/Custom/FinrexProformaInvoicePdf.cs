...
/// </summary>
public class FinrexProformaInvoicePdf
{
	public string GenerateInvoice(int id)
	{
        ...
        string query = @"SELECT * FROM tbl_proformainvoice t1
                          ...
                          WHERE t1.proformainvoice_proformainvoiceid =" + id;
        DataRow dr = DbTable.ExecuteSelectRow(query);
        if (dr == null) return "";

        try
        {
            fileName = "proformainvoice-" + Guid.NewGuid().ToString() + "_Proforma_" + GlobalUtilities.ConvertToString(dr["proformainvoice_proformainvoiceno"]).Replace("/", "-") + "_" + id + ".pdf";
            ...
            {
                invoiceDate = GlobalUtilities.ConvertToDate(dr["proformainvoice_date"]);
            }

            obj.Generate(filePath);

            AddHeader(obj);
            html = @"<table cellspacing=0 cellpadding=0><tr><td style='text-align:right;padding-bottom:10px;' width='55%'><font style='font-size:12px;color:#2E3092;'>PROFORMA INVOICE</font></td>
            ...
            html = @"<table cellspacing=0 cellpadding=0>
                        ...
                        <td width='50%' valign='top'>
                             <table cellspacing=0 cellpadding=0>
                                ...
                                <tr><td>"+GlobalUtilities.ConvertToString(dr["proformainvoice_billingaddress"]).Replace("\n", "</br>")+@"</td></tr>
                             </table>
                        </td>
                        <td>
                            <table cellspacing=2 cellpadding=0>
                                <tr><td><b>Invoice No.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b> " + GlobalUtilities.ConvertToString(dr["proformainvoice_proformainvoiceno"]) + @"</td></tr>
            ...
            html = @"<table cellspacing=0 cellpadding=3 border=0.5>
                        <tr>
                            <td><b>Director Name</b><br/>" + GlobalUtilities.ConvertToString(dr["proformainvoice_directorname"]) + @"</td>
                            <td><b>Director Mobile No</b><br/>" + GlobalUtilities.ConvertToString(dr["proformainvoice_directormobile"]) + @"</td>
                            <td><b>Director Email Id</b><br/>" + GlobalUtilities.ConvertToString(dr["proformainvoice_directoremailid"]) + @"</td>
                            <td><b>GSTIN No</b><br/>" + GlobalUtilities.ConvertToString(dr["proformainvoice_gstin"]) + @"</td>
                        </tr>
                        <tr>
                            <td><b>Finance Name</b><br/>" + GlobalUtilities.ConvertToString(dr["proformainvoice_financename"]) + @"</td>
                            <td><b>Finance Mobile No</b><br/>" + GlobalUtilities.ConvertToString(dr["proformainvoice_financemobile"]) + @"</td>
                            <td><b>Finance Email Id</b><br/>" + GlobalUtilities.ConvertToString(dr["proformainvoice_financeemailid"]) + @"</td>
                            <td><b>Office Tel No.</b><br/>" + GlobalUtilities.ConvertToString(dr["proformainvoice_officetelno"]) + @"</td>
                        </tr>
                    </table>";
            obj.AddHTML(html);
            bool isGst = false;
            query = @"select * from tbl_proformainvoicedetail
                            ...
                            where proformainvoicedetail_proformainvoiceid=" + id;
            DataTable dttbl = DbTable.ExecuteSelect(query);
            string tableHtml = GetGSTTableFormat(id, dr, dttbl, "proformainvoice", "proformainvoicedetail", out isGst);
    ...
    private string GetGSTTableFormat(int id, DataRow dr, DataTable dttbl, string mainTable, string subtable, out bool isGST)
    {
        ...
        while (i < dttbl.Rows.Count)
        {
            ...
            else
            {
                ...
                query = @"select * from tbl_proformainvoiceprospects
                        join tbl_prospect on prospect_prospectid=proformainvoiceprospects_prospectid
                        where proformainvoiceprospects_proformainvoiceid=" + id;
