...
/// </summary>
public static class UpdatableJSGrid
{
    ...
    public static string bindGrid(string strNodAttrName, string strModuleName)
    {
        ...
        if (strQuery != "")
        {
            return bindGrid(DbTable.ExecuteSelect(strQuery), strHtmlScript, arrGridColumns, arrGridColumnsHeader);
        }
        else
        {
