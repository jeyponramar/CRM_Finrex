...
public partial class AccountVoucherBreakup_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_accountvoucherbreakup", "accountvoucherbreakupid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Account Voucher Breakup";
        }
        else
        {
            lblPageTitle.Text = "Edit Account Voucher Breakup";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/AccountVoucherBreakup/view.aspx");
    }
