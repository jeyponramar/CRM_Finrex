...
public partial class ProductModel_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_productmodel", "productmodelid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Product Model";
        }
        else
        {
            lblPageTitle.Text = "Edit Product Model";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/ProductModel/view.aspx");
    }
