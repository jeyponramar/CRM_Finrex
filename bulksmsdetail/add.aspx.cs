...
public partial class BulkSMSDetail_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bulksmsdetail", "bulksmsdetailid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bulk SMS Detail";
        }
        else
        {
            lblPageTitle.Text = "Edit Bulk SMS Detail";
        }
