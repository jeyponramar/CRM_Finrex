...
public partial class EnterpriseType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_enterprisetype", "enterprisetypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Enterprise Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Enterprise Type";
        }
