...
public partial class APIRequestHistory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_apirequesthistory", "apirequesthistoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add API Request History";
        }
        else
        {
            lblPageTitle.Text = "Edit API Request History";
        }
