...
{
    GlobalData gblData = new GlobalData("tbl_feedback", "feedbackid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
			...
			gblData.FillDropdown(ddlfeedbackratingid, "tbl_feedbackrating", "feedbackrating_rating", "feedbackrating_feedbackratingid", "", "feedbackrating_rating");
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Feedback";
        }
        else
        {
            lblPageTitle.Text = "Edit Feedback";
        }
    ...
    private int SaveData(bool isclose)
    {
        ...
        {
            gblData.AddExtraValues("followupstatusid", 2);
        }
