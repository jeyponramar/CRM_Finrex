...
public partial class BankAuditYearlyNetProfit_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankaudityearlynetprofit", "bankaudityearlynetprofitid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Yearly Net Profit";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Yearly Net Profit";
        }
