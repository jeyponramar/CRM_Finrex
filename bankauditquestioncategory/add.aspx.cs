...
public partial class BankAuditQuestionCategory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditquestioncategory", "bankauditquestioncategoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Question Category";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Question Category";
        }
