...
public partial class InterestRateUploadHistory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_interestrateuploadhistory", "interestrateuploadhistoryid");
    
    protected void Page_Load(object sender, EventArgs e)
    {
        Response.Redirect("~/importdata/import-interestrate.aspx?id=" + Request.QueryString["id"]);
        if (!IsPostBack)
        {
            //FillDropDown_START
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Interest Rate Upload History";
        }
        else
        {
            lblPageTitle.Text = "Edit Interest Rate Upload History";
        }
