...
public partial class EmployeeType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_employeetype", "employeetypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Employee Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Employee Type";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/EmployeeType/view.aspx");
		}
    }
