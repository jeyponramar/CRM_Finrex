...
public partial class PushNotificationAppType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_pushnotificationapptype", "pushnotificationapptypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Push Notification App Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Push Notification App Type";
        }
