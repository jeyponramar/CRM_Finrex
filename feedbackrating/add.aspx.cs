...
public partial class FeedbackRating_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_feedbackrating", "feedbackratingid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Feedback Rating";
        }
        else
        {
            lblPageTitle.Text = "Edit Feedback Rating";
        }
