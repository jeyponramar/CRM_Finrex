 ...
 CodeFile="add.aspx.cs" Inherits="BuyerCreditEnquiry_add" EnableEventValidation="false" ValidateRequest="false"%>
					...
					<tr>
						...
						<asp:RequiredFieldValidator ID="rfv8" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Required Description of Underlying Goods" ValidationGroup="vg" ControlToValidate="txtdescriptionofunderlyinggoods"></asp:RequiredFieldValidator></td>
										...
										<tr>
											...
											<td ti='9'><asp:TextBox ID="txttransactionamountwithcurrency"  dcn="buyercreditenquiry_transactionamountwithcurrency" runat="server" MaxLength="15" CssClass="mbox val-dbl" Text="0"></asp:TextBox>
