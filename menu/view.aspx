<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="view.aspx.cs" Inherits="Menu_view" %>
        ...
        <td width="80%" style="vertical-align:top" class="tddatapanel">
            <table width="100%">
                <tr>
                 ...
                 <tr>
                    <td colspan="2">
                        <uc:Grid id="grid" runat="server" Module="Menu"/>
                    </td>
                 </tr>
            </table>
        </td>
