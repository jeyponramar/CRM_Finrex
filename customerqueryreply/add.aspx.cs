...
public partial class CustomerQueryReply_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_customerqueryreply", "customerqueryreplyid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Customer Query Reply";
        }
        else
        {
            lblPageTitle.Text = "Edit Customer Query Reply";
        }
