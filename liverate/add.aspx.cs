...
public partial class LiveRate_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_liverate", "liverateid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Live Rate";
        }
        else
        {
            lblPageTitle.Text = "Edit Live Rate";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if(SaveData(false) > 0)
        {
			Response.Redirect("~/LiveRate/view.aspx");
		}
    }
