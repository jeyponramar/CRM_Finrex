...
public partial class EmailIntegrationModule_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_emailintegrationmodule", "emailintegrationmoduleid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Email Integration Module";
        }
        else
        {
            lblPageTitle.Text = "Edit Email Integration Module";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/EmailIntegrationModule/view.aspx");
		}
    }
