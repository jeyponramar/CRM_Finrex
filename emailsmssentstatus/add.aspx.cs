...
public partial class EmailSMSSentStatus_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_emailsmssentstatus", "emailsmssentstatusid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Email SMS Sent Status";
        }
        else
        {
            lblPageTitle.Text = "Edit Email SMS Sent Status";
        }
