...
public partial class FAQcategory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_faqcategory", "faqcategoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add FAQ category";
        }
        else
        {
            lblPageTitle.Text = "Edit FAQ category";
        }
