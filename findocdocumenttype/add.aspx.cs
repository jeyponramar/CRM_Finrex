...
public partial class FinDocDocumentType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_findocdocumenttype", "findocdocumenttypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add FinDoc Document Type";
        }
        else
        {
            lblPageTitle.Text = "Edit FinDoc Document Type";
        }
