...
public partial class HedgingPolicyMaster_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_hedgingpolicymaster", "hedgingpolicymasterid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Hedging Policy Master";
        }
        else
        {
            lblPageTitle.Text = "Edit Hedging Policy Master";
        }
