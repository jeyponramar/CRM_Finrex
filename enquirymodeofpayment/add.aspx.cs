...
public partial class EnquiryModeofPayment_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_enquirymodeofpayment", "enquirymodeofpaymentid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Enquiry Mode of Payment";
        }
        else
        {
            lblPageTitle.Text = "Edit Enquiry Mode of Payment";
        }
