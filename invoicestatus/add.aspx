 ...
 CodeFile="add.aspx.cs" Inherits="InvoiceStatus_add" EnableEventValidation="false" ValidateRequest="false"%>
					...
					<tr>
								...
								<tr>
									<td width='50%' class='valign'>
										...
										<tr>
											...
											<td ti='0'><asp:TextBox ID="txtstatus"  IsUnique="true"  search='true'  MaxLength="100" runat="server"  dcn="invoicestatus_status" CssClass="textbox"></asp:TextBox>
						<asp:RequiredFieldValidator ID="rfv0" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Required Status" ValidationGroup="vg" ControlToValidate="txtstatus"></asp:RequiredFieldValidator></td>
										...
										<tr>
											...
											<td ti='1'><asp:TextBox ID="txttextcolor"  MaxLength="100" runat="server"  dcn="invoicestatus_textcolor" CssClass="textbox"></asp:TextBox></td>
										</tr>
										<tr>
											<td class="label">Background Color</td>
											<td ti='2'><asp:TextBox ID="txtbackgroundcolor"  MaxLength="100" runat="server"  dcn="invoicestatus_backgroundcolor" CssClass="textbox"></asp:TextBox></td>
										</tr>
										</table>
									</td>
									<td width='50%' class='valign'>
