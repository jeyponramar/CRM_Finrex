...
public partial class InvoiceStatus_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_invoicestatus", "invoicestatusid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Invoice Status";
        }
        else
        {
            lblPageTitle.Text = "Edit Invoice Status";
        }
