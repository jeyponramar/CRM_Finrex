...
(function($) {
    ...
    UploadHandler = function(container, options) {
        ...
        this.initUploadRow = function(event, files, index, xhr, handler, callBack) {
            //RAM
            handler.uploadTable = _selectedFileDiv.closest("table").find(".tblfiles");
        ...
        this.initDownloadRow = function(event, files, index, xhr, handler, callBack) {
            //RAM
            handler.downloadTable = _selectedFileDiv.closest("table").find(".tblfiles");
        ...
        //RAM - removed to avoid disturb in display while dragging anything
        /*
