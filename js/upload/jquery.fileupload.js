    ...
    FileUpload = function(container) {
        var fileUpload = this,
            ...
            getUrl = function(settings) {
                ...
                //                }
                //return settings.url;
                var isguid = _selectedFileDiv.attr("isguid");
                var resize = _selectedFileDiv.attr("resize");
                var size = _selectedFileDiv.attr("size");
                var fileprefix = _selectedFileDiv.attr("fileprefix");
                if (isguid == "") isguid = false;
                var url = _fileUploadPrefix + "BulkFileUpload.ashx?folderpath=" + _selectedFileDiv.attr("folder") + "&isguid=" + isguid + "&resize=" + resize
                            + "&size=" + size + "&fileprefix=" + fileprefix+"&m="+_selectedFileDiv.attr("m")+"&mid="+_selectedFileDiv.attr("mid")
                            +"&cm="+_selectedFileDiv.attr("cm")+"&cmid="+_selectedFileDiv.attr("cmid");
                return url;
            },
