...
public partial class InterestRate_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_interestrate", "interestrateid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Interest Rate";
        }
        else
        {
            lblPageTitle.Text = "Edit Interest Rate";
        }
