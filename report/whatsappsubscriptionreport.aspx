<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="whatsappsubscriptionreport.aspx.cs" 
Inherits="whatsappsubscriptionreport" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Whatsapp Report - Subscription"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
			<table width='100%'>
			<!--CONTROLS_START-->
				<tr><td><uc:Grid ID="grid" runat="server" Module="whatsappsubscriptionreport" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
