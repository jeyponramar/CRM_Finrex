...
public partial class opportunitybyengineer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
			...
			gblData.FillDropdown(opportunity_opportunitystatusid, "tbl_opportunitystatus", "opportunitystatus_status", "");
			//FillDropDown_END
