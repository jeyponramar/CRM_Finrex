<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="enquirybyclient.aspx.cs" Inherits="enquirybyclient" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Enquiry by Client"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
			...
			<tr><td>
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="enquirybyclient" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
