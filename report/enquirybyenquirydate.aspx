<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="enquirybyenquirydate.aspx.cs" Inherits="enquirybyenquirydate" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Enquiry by Enquiry Date"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
			...
			<tr><td>
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="enquirybyenquirydate" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
