<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="customerwiseinvoicereport.aspx.cs" Inherits="customerwiseinvoicereport" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Customer Wise Invoice Report"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
            <uc:Grid id="grid" runat="server" Module="customerwiseinvoicereport" IsReport="true"/>
        </td>
     </tr>
</table>
<!--DESIGN_END-->
