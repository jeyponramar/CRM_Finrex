<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="outstandingpayable.aspx.cs" Inherits="outstandingpayable" %>
    ...
    <tr>
        <td width="80%" style="vertical-align:top" class="tddatapanel">
            <table width="100%">
                <tr>
                    <td class="title">
                        <asp:Label ID="lblPageTitle" runat="server" Text="Outstanding Payable"/>
                    </td>
                 </tr>
                 <tr>
                    <td>
                        <uc:Grid id="grid" runat="server" Module="outstandingpayable"/>
                    </td>
                 </tr>
            </table>
        </td>
