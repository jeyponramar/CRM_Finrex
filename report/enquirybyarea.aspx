<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="enquirybyarea.aspx.cs" Inherits="enquirybyarea" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Enquiry by Area"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
			...
			<tr><td>
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="enquirybyarea" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
