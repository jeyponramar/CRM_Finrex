<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="quotationbyclient.aspx.cs" Inherits="quotationbyclient" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Quotation BY Client"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
            <uc:Grid id="grid" runat="server" Module="quotationbyclient" IsReport="true"/>
        </td>
     </tr>
</table>
<!--DESIGN_END-->
