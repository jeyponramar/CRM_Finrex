<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="complaintbyengineer.aspx.cs" Inherits="complaintbyengineer" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Complaint by Engineer"></asp:Label>
        </td>
			...
			<tr><td>
				...
				<table>
					...
					<td><asp:TextBox ID="complaint_employeeid" runat="server" m="employee" cn="employeename" CssClass="textbox ac txtac" Include="0"></asp:TextBox>
						<asp:TextBox ID="txtcomplaint_employeeid" Text="0" runat="server" class=" hdnac" Format="Int" />
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="complaintbyengineer" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
