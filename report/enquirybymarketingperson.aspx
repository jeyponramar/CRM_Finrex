<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="enquirybymarketingperson.aspx.cs" Inherits="enquirybymarketingperson" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Enquiry by Marketing Person"></asp:Label>
        </td>
			...
			<tr><td>
				...
				<table>
					...
					<td><asp:TextBox ID="enquiry_employeeid" runat="server" m="employee" cn="employeename" cm="marketingexecutive" CssClass="textbox ac txtac" Include="0"></asp:TextBox>
						<asp:TextBox ID="txtenquiry_employeeid" Text="0" runat="server" class=" hdnac" Format="Int" /><img src='../images/down-arr1.jpg'/></td>
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="enquirybymarketingperson" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
