<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="task.aspx.cs" Inherits="task" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Task"></asp:Label>
        </td>
        ...
        <td colspan="2">
			...
			<tr><td>
				...
				<table>
					...
					<tr>
					<td>Assigned To</td>
					<td><asp:TextBox ID="followups_employeeid" runat="server" m="employee" cn="employeename" CssClass="textbox ac txtac" Include="0"></asp:TextBox>
						<asp:TextBox ID="txtfollowups_employeeid" Text="0" runat="server" class=" hdnac" Format="Int" />
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="salespersontask" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
