<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="complaintbycomplainttype.aspx.cs" Inherits="complaintbycomplainttype" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Complaint by Complaint Type"></asp:Label>
        </td>
			...
			<tr><td>
				...
				<table>
					...
					<td><asp:TextBox ID="complaint_complainttypeid" runat="server" m="complainttype" cn="complainttype" CssClass="textbox ac txtac" Include="0"></asp:TextBox>
						<asp:TextBox ID="txtcomplaint_complainttypeid" Text="0" runat="server" class=" hdnac" Format="Int" />
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="complaintbycomplainttype" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
