<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="receivableforthirtydays.aspx.cs" Inherits="receivableforthirtydays" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Receivable for 30 days"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
			...
			<!--CONTROLS_START-->
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="receivableforthirtydays" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
