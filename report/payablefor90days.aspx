<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="payablefor90days.aspx.cs" Inherits="payablefor90days" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Payable for 90 days"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
			...
			<!--CONTROLS_START-->
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="payablefor90days" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
