<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="todaytelecallerfollowups.aspx.cs" Inherits="todaytelecallerfollowups" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Today Tele Caller Followups"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
			...
			<!--CONTROLS_START-->
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="todaytelecallerfollowups" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
