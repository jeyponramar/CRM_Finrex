<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="pendingtelecallfollowups.aspx.cs" Inherits="pendingtelecallfollowups" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Pending Tele Call Followups"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
			...
			<!--CONTROLS_START-->
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="pendingtelecallfollowups" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
