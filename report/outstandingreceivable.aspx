<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="outstandingreceivable.aspx.cs" Inherits="outstandingreceivable" %>
    ...
    <tr>
        <td width="80%" style="vertical-align:top" class="tddatapanel">
            <table width="100%">
                <tr>
                    <td class="title">
                        <asp:Label ID="lblPageTitle" runat="server" Text="Outstanding Receivable"/>
                    </td>
                 </tr>
                 <tr>
                    <td>
                        <uc:Grid id="grid" runat="server" Module="outstandingreceivable"/>
                    </td>
                 </tr>
            </table>
        </td>
