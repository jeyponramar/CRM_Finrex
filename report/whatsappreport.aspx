<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="whatsappreport.aspx.cs" Inherits="whatsappreport" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Whatsapp Report"></asp:Label>
        </td>
			...
			<tr><td>
				...
				<table width='75%'><tr><td>
					...
					<div class='report-field' id='Div1' runat='server'>
						<div class='report-label'>End Date</div>
					<div class='report-label'>From : </div><div class='report-control'><asp:TextBox ID="client_enddate_from" CssClass="datepicker from" runat="server" Format="Date"/></div>
						<div class='report-label'>To : </div><div class='report-control'><asp:TextBox ID="client_enddate_to" CssClass="datepicker to" runat="server" Format="Date"/></div>
					</div>
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="whatsappreport" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
