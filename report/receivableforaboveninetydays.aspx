<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="receivableforaboveninetydays.aspx.cs" Inherits="receivableforaboveninetydays" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Receivable for Above 90 Days"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
			...
			<!--CONTROLS_START-->
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="receivableforaboveninetydays" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
