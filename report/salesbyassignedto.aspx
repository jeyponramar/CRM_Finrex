<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="salesbyassignedto.aspx.cs" Inherits="salesbyassignedto" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Sales by Assigned To"></asp:Label>
        </td>
        ...
        <td colspan="2">
			...
			<tr><td>
				...
				<table>
					...
					<tr>
					<td>Assigned To</td>
					<td><asp:TextBox ID="enquiry_employeeid" runat="server" m="employee" cn="employeename" CssClass="textbox ac txtac" Include="0"></asp:TextBox>
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="salesbyassignedto" IsReport="true" GridSumColumns="sales_totalamount"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
