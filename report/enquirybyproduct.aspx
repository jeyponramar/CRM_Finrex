<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="enquirybyproduct.aspx.cs" Inherits="enquirybyproduct" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Enquiry by Product"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
			...
			<tr><td>
				...
				<tr><td><uc:Grid ID="grid" runat="server" Module="enquirybyproduct" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
