<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="enquirybyenquiryfor.aspx.cs" Inherits="enquirybyenquiryfor" %>
...
<table width="100%">
     <tr>
        <td class="title">
            <asp:Label ID="lblPageTitle" runat="server"  Text="Enquiry by Enquiry For"></asp:Label>
        </td>
     ...
     <tr>
        <td colspan="2">
			...
			<tr><td>
				...
				<tr><td><uc:PieChart ID="chart" runat="server" ColumnName="" Module="enquirybyenquiryfor" ColumnHeader="" BarColor="" /></td></tr>
				<tr><td><uc:Grid ID="grid" runat="server" Module="enquirybyenquiryfor" IsReport="true"/></td></tr>
					<!--CONTROLS_END-->
			</table>
        </td>
     </tr>
