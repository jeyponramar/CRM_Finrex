...
public partial class KnowledgeSeries_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_knowledgeseries", "knowledgeseriesid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Knowledge Series";
        }
        else
        {
            lblPageTitle.Text = "Edit Knowledge Series";
        }
