...
{
    GlobalData gblData = new GlobalData("tbl_currency", "currencyid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Currency";
        }
        else
        {
            lblPageTitle.Text = "Edit Currency";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if(SaveData(false) > 0)
        {
			Response.Redirect("~/Currency/view.aspx");
		}
    }
