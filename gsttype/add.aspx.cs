...
public partial class GSTTYPE_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_gsttype", "gsttypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add GSTTYPE";
        }
        else
        {
            lblPageTitle.Text = "Edit GSTTYPE";
        }
