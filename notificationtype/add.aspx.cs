...
public partial class NotificationType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_notificationtype", "notificationtypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Notification Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Notification Type";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if(SaveData(false) > 0)
        {
			Response.Redirect("~/NotificationType/view.aspx");
		}
    }
