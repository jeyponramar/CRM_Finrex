...
public partial class SerialNo_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_serialno", "serialnoid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Serial No";
        }
        else
        {
            lblPageTitle.Text = "Edit Serial No";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/SerialNo/view.aspx");
    }
