...
public partial class ProductSubmittedBy_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_productsubmittedby", "productsubmittedbyid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Product Submitted By";
        }
        else
        {
            lblPageTitle.Text = "Edit Product Submitted By";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/ProductSubmittedBy/view.aspx");
    }
