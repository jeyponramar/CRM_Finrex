...
public partial class EnquiryStage_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_enquirystage", "enquirystageid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Enquiry Stage";
        }
        else
        {
            lblPageTitle.Text = "Edit Enquiry Stage";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/EnquiryStage/view.aspx");
		}
    }
