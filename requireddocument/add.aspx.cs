...
public partial class RequiredDocument_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_requireddocument", "requireddocumentid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Required Document";
        }
        else
        {
            lblPageTitle.Text = "Edit Required Document";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if(SaveData(false) > 0)
        {
			Response.Redirect("~/RequiredDocument/view.aspx");
		}
    }
