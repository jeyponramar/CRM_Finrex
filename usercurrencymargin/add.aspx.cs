...
public partial class UserCurrencyMargin_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_usercurrencymargin", "usercurrencymarginid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add User Currency Margin";
        }
        else
        {
            lblPageTitle.Text = "Edit User Currency Margin";
        }
