...
public partial class SalesStatus_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_salesstatus", "salesstatusid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Sales Status";
        }
        else
        {
            lblPageTitle.Text = "Edit Sales Status";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/SalesStatus/view.aspx");
		}
    }
