 ...
 CodeFile="add.aspx.cs" Inherits="SalesStatus_add" EnableEventValidation="false" ValidateRequest="false"%>
					...
					<tr>
								...
								<tr>
									<td width='50%' class='valign'>
										...
										<tr>
											...
											<td><asp:TextBox ID="txtstatus"  IsUnique="true" MaxLength="100" runat="server"  dcn="salesstatus_status" CssClass="textbox"></asp:TextBox>
						<asp:RequiredFieldValidator ID="rfv0" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Required Status" ValidationGroup="vg" ControlToValidate="txtstatus"></asp:RequiredFieldValidator></td>
										...
										<tr>
											...
											<td><asp:TextBox ID="txttextcolor" MaxLength="100" runat="server"  dcn="salesstatus_textcolor" CssClass="textbox"></asp:TextBox></td>
										</tr>
										<tr>
											<td class="label">Background Color</td>
											<td><asp:TextBox ID="txtbackgroundcolor" MaxLength="100" runat="server"  dcn="salesstatus_backgroundcolor" CssClass="textbox"></asp:TextBox></td>
										</tr>
										</table>
									</td>
									<td width='50%' class='valign'>
