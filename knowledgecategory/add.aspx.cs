...
public partial class KnowledgeCategory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_knowledgecategory", "knowledgecategoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Knowledge Category";
        }
        else
        {
            lblPageTitle.Text = "Edit Knowledge Category";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/KnowledgeCategory/view.aspx");
		}
    }
