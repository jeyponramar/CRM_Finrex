...
public partial class BankAuditAnnualCurrencyTurnover_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditannualcurrencyturnover", "bankauditannualcurrencyturnoverid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Annual Currency Turnover";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Annual Currency Turnover";
        }
