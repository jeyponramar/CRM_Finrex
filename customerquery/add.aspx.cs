...
public partial class CustomerQuery_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_customerquery", "customerqueryid");
    
    protected void Page_Load(object sender, EventArgs e)
    {
        Response.Redirect("~/advisor/querydetail.aspx?id=" + Request.QueryString["id"]);
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Customer Query";
        }
        else
        {
            lblPageTitle.Text = "Edit Customer Query";
        }
