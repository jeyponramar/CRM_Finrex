...
public partial class EmailReminder_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_emailreminder", "emailreminderid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Email Reminder";
        }
        else
        {
            lblPageTitle.Text = "Edit Email Reminder";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/EmailReminder/view.aspx");
    }
