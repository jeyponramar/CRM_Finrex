...
public partial class InterestRateType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_interestratetype", "interestratetypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Interest Rate Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Interest Rate Type";
        }
