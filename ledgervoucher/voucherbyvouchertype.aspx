<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="voucherbyvouchertype.aspx.cs" Inherits="voucherbyvouchertype" %>
        ...
        <td width="80%" style="vertical-align:top" class="tddatapanel">
            <table width="100%">
                <tr>
                 ...
                 <tr>
                    <td colspan="2">
                        <uc:Grid id="grid" runat="server" Module="voucherbyvouchertype"/>
                    </td>
                 </tr>
            </table>
        </td>
