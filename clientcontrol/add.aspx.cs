...
public partial class ClientControl_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_clientcontrol", "clientcontrolid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Client Control";
        }
        else
        {
            lblPageTitle.Text = "Edit Client Control";
        }
