...
public partial class ActionRights_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_actionrights", "actionrightsid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Action Rights";
        }
        else
        {
            lblPageTitle.Text = "Edit Action Rights";
        }
