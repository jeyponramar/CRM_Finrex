...
public partial class FinDocDocument_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_findocdocument", "findocdocumentid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add FinDoc Document";
        }
        else
        {
            lblPageTitle.Text = "Edit FinDoc Document";
        }
