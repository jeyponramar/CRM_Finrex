...
public partial class Futureforwardrate_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_futureforwardrate", "futureforwardrateid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Futureforwardrate";
        }
        else
        {
            lblPageTitle.Text = "Edit Futureforwardrate";
        }
