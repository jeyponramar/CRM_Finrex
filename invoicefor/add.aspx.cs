...
public partial class Invoicefor_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_invoicefor", "invoiceforid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Invoice for";
        }
        else
        {
            lblPageTitle.Text = "Edit Invoice for";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/Invoicefor/view.aspx");
		}
    }
