...
public partial class TopicSubMenu_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_topicsubmenu", "topicsubmenuid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Topic Sub Menu";
        }
        else
        {
            lblPageTitle.Text = "Edit Topic Sub Menu";
        }
