...
using WebComponent;
public partial class tradefinanceenquiry_export_lc_discounting : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_exportlcdiscountingenquiry", "exportlcdiscountingenquiryid");
    ...
    {
        string query = "";
        query = @"select * from tbl_exportlcdiscountingenquiry
        ...
        query += " where exportlcdiscountingenquiry_exportlcdiscountingenquiryid=" + id;
        DataRow dr = DbTable.ExecuteSelectRow(query);
        string body = Common.GetFormattedSettingForEmail("tradefinanceenquiry-export-lc-discounting", dr);
        BulkEmail.SendMail_Alert("tradefinance@finrex.in", "", "", "Export Finance - Export LC Discounting Enquiry", body, "");
    }
