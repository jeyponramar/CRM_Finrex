...
public partial class IndustryTypes_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_industrytypes", "industrytypesid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Industry Types";
        }
        else
        {
            lblPageTitle.Text = "Edit Industry Types";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/IndustryTypes/view.aspx");
		}
    }
