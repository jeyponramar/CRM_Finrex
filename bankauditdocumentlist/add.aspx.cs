...
public partial class BankAuditDocumentList_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditdocumentlist", "bankauditdocumentlistid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Document List";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Document List";
        }
