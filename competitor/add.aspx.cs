...
public partial class Competitor_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_competitor", "competitorid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Competitor";
        }
        else
        {
            lblPageTitle.Text = "Edit Competitor";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if(SaveData(false) > 0)
        {
			Response.Redirect("~/Competitor/view.aspx");
		}
    }
