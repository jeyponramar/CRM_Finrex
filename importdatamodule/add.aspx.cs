...
public partial class ImportDataModule_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_importdatamodule", "importdatamoduleid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Import Data Module";
        }
        else
        {
            lblPageTitle.Text = "Edit Import Data Module";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/ImportDataModule/view.aspx");
		}
    }
