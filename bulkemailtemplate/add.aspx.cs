...
public partial class BulkEmailTemplate_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bulkemailtemplate", "bulkemailtemplateid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bulk Email Template";
        }
        else
        {
            lblPageTitle.Text = "Edit Bulk Email Template";
        }
