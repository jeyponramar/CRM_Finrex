...
public partial class FTPClientHistory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_ftpclienthistory", "ftpclienthistoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add FTP Client History";
        }
        else
        {
            lblPageTitle.Text = "Edit FTP Client History";
        }
