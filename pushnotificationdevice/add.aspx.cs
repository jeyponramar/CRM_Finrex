...
public partial class PushNotificationDevice_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_pushnotificationdevice", "pushnotificationdeviceid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Push Notification Device";
        }
        else
        {
            lblPageTitle.Text = "Edit Push Notification Device";
        }
