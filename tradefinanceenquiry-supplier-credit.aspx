<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="tradefinanceenquiry-supplier-credit.aspx.cs" 
Inherits="tradefinanceenquiry_supplier_credit" Title="Import Finance - Supplier Credit" %>
...
<table width='100%' cellspacing=0 cellpadding=0>
    <tr><td class='page-inner2'>
        <table width='100%'><tr><td class='page-title2'>Import Finance - Supplier Credit</td></tr>
           <tr>
					...
					<tr>
						...
						<asp:RequiredFieldValidator ID="rfv8" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Required Description of Underlying Goods" ValidationGroup="vg" ControlToValidate="txtdescriptionofunderlyinggoods"></asp:RequiredFieldValidator></td>
										...
										<tr>
											...
											<td ti='9'><asp:TextBox ID="txttransactionamountwithcurrency"  dcn="suppliercreditenquiry_transactionamountwithcurrency" runat="server" MaxLength="100" CssClass="textbox"></asp:TextBox>
