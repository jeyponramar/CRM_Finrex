...
public partial class IndianEcoIndicators_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_indianecoindicators", "indianecoindicatorsid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Indian Eco Indicators";
        }
        else
        {
            lblPageTitle.Text = "Edit Indian Eco Indicators";
        }
