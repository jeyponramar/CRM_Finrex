<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="viewalternatereferencerates.aspx.cs" 
Inherits="viewalternatereferencerates" %>
...
<table width='100%' cellspacing=0 cellpadding=0>
    <tr><td class='page-inner2'>
        <table width='100%'><tr><td class='page-title2'>Alternative Reference Rate (ARR) %</td></tr>
        <tr>
            <td>
                <table cellspacing=10>
                    <tr>
                        <td width="100" class="bold">Currency : </td>
                        <td><asp:DropDownList ID="ddlcurrency" runat="server" style="width:120px;height:25px;">
                        </asp:DropDownList></td>
                        <td width="100" class="bold">ARR : </td>
                        <td><asp:DropDownList ID="ddlarr" runat="server" style="width:120px;height:25px;">
                        </asp:DropDownList></td>
                    </tr>
                    <tr>
