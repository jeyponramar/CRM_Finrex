...
public partial class AlternativeReferenceRate_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_alternativereferencerate", "alternativereferencerateid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
			...
			gblData.FillDropdown(ddlarrmasterid, "tbl_arrmaster", "arrmaster_name", "arrmaster_arrmasterid", "", "arrmaster_name");
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Alternative Reference Rates";
        }
        else
        {
            lblPageTitle.Text = "Edit Alternative Reference Rates";
        }
