...
public partial class ClientCompetitor_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_clientcompetitor", "clientcompetitorid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Client Competitor";
        }
        else
        {
            lblPageTitle.Text = "Edit Client Competitor";
        }
    ...
    private int SaveData(bool isclose)
    {
		...
		if(Request.QueryString["id"] == null)
		{
			Common.AddExtraQueryStringVal(gblData, "clientid");
		}
		//ExtraValues_END
        int id = 0;
