...
public partial class Charges_add : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Charges";
        }
        else
        {
            lblPageTitle.Text = "Edit Charges";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
        {
            Response.Redirect("~/Charges/view.aspx");
        }
    }
    private int SaveData(bool isclose)
    {
        ...
        //ExtraValues_START
        //ExtraValues_END
        gblData.AddExtraValues("ischarges", true);
        int id = 0;
