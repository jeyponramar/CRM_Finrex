...
public partial class BankAuditStatus_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditstatus", "bankauditstatusid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Status";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Status";
        }
