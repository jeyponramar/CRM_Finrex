...
public partial class LCStatus_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_lcstatus", "lcstatusid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add LC Status";
        }
        else
        {
            lblPageTitle.Text = "Edit LC Status";
        }
