...
public partial class MenuRights_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_menurights", "menurightsid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Menu Rights";
        }
        else
        {
            lblPageTitle.Text = "Edit Menu Rights";
        }
	...
	private void PopulateSubGrid()
	{
		...
		//sgrid.Populate(gblData, ltmenurightsdetail, menurightsdetail_param, menurightsdetail_setting);
	}
			//PopulateSubGrid_END
    ...
    private int SaveData(bool isclose)
    {
        ...
        if (id > 0)
        {
			...
			//gblData.SaveSubTable(id, gblData, menurightsdetail_setting);
			//SaveSubTable_END
