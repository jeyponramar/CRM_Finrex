...
public partial class ContactType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_contacttype", "contacttypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Contact Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Contact Type";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if(SaveData(false) > 0)
        {
			Response.Redirect("~/ContactType/view.aspx");
		}
    }
