...
public partial class FundingTypeMaster_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_fundingtypemaster", "fundingtypemasterid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Funding Type Master";
        }
        else
        {
            lblPageTitle.Text = "Edit Funding Type Master";
        }
