...
public partial class BuySellScriptType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_buysellscripttype", "buysellscripttypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Buy Sell Script Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Buy Sell Script Type";
        }
