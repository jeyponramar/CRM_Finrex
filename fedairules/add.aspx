 ...
 CodeFile="add.aspx.cs" Inherits="FedaiRules_add" EnableEventValidation="false" ValidateRequest="false"%>
					...
					<tr>
								...
								<tr>
									<td width='50%' class='valign'>
										...
										<tr>
											...
											<td ti='0'><asp:TextBox ID="txtdate"  dcn="fedairules_date" runat="server" autocomplete="off" MaxLength="11" Format="Date" CssClass="textbox datepicker"></asp:TextBox>
						<asp:RequiredFieldValidator ID="rfv0" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Required Date" ValidationGroup="vg" ControlToValidate="txtdate"></asp:RequiredFieldValidator></td>
										...
										<tr>
											...
											<td ti='1'><asp:TextBox TextMode="MultiLine" ID="txtparticular"  dcn="fedairules_particular" ml="800" runat="server" CssClass="textarea"></asp:TextBox></td>
										</tr>
										<tr>
											<td class="label">Url</td>
											<td ti='2'><asp:TextBox TextMode="MultiLine" ID="txturl"  dcn="fedairules_url" ml="800" runat="server" CssClass="textarea"></asp:TextBox></td>
										</tr>
										<tr>
											<td class="label">Remark</td>
											<td ti='3'><asp:TextBox TextMode="MultiLine" ID="txtremark"  dcn="fedairules_remark" ml="300" runat="server" CssClass="textarea"></asp:TextBox></td>
										</tr>
										<tr>
											<td class="label">Document</td>
											<td ti='4'><uc:MultiFileUpload ID="mfudocument"  IsMultiple="false" FileType="Any" FolderPath="upload/fedairules" SaveExt="true" runat="server" CssClass="textbox "></uc:MultiFileUpload>
