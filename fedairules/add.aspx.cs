...
public partial class FedaiRules_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_fedairules", "fedairulesid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Fedai Rules";
        }
        else
        {
            lblPageTitle.Text = "Edit Fedai Rules";
        }
