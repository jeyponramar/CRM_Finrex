...
public partial class ForwardContractBookingMaster_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_forwardcontractbookingmaster", "forwardcontractbookingmasterid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Forward Contract Booking Master";
        }
        else
        {
            lblPageTitle.Text = "Edit Forward Contract Booking Master";
        }
