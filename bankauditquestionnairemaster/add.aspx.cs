...
public partial class BankAuditQuestionnaireMaster_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditquestionnairemaster", "bankauditquestionnairemasterid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Questionnaire Master";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Questionnaire Master";
        }
