...
public partial class RBIDataRelease_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_rbidatarelease", "rbidatareleaseid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add RBI Data Release";
        }
        else
        {
            lblPageTitle.Text = "Edit RBI Data Release";
        }
