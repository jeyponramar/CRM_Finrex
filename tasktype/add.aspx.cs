...
{
    GlobalData gblData = new GlobalData("tbl_tasktype", "tasktypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Task Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Task Type";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/TaskType/view.aspx");
		}
    }
