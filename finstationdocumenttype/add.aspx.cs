...
public partial class FinstationDocumentType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_finstationdocumenttype", "finstationdocumenttypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Finstation Document Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Finstation Document Type";
        }
