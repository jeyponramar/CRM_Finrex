...
public partial class SMSDeliveryHistory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_smsdeliveryhistory", "smsdeliveryhistoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add SMS Delivery History";
        }
        else
        {
            lblPageTitle.Text = "Edit SMS Delivery History";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/SMSDeliveryHistory/view.aspx");
		}
    }
