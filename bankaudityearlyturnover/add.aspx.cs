...
public partial class BankAuditYearlyTurnOver_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankaudityearlyturnover", "bankaudityearlyturnoverid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Yearly Turn Over";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Yearly Turn Over";
        }
