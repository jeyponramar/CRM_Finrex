...
{
    GlobalData gblData = new GlobalData("tbl_product", "productid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
			...
			gblData.FillDropdown(ddlunitid, "tbl_unit", "unit_unit", "unit_unitid", "", "unit_unit");
            ...
            else
            {
                ...
                //Populate_END
                if (GlobalUtilities.ConvertToBool(gblData._CurrentRow["product_ischarges"]))
                {
                    Response.Redirect("../charges/add.aspx?id=" + Request.QueryString["id"]);
                }
            }
