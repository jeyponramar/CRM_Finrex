...
public partial class AccountAdjustmentMethod_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_accountadjustmentmethod", "accountadjustmentmethodid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Account Adjustment Method";
        }
        else
        {
            lblPageTitle.Text = "Edit Account Adjustment Method";
        }
    ...
    {
        SaveData(false);
        Response.Redirect("~/AccountAdjustmentMethod/view.aspx");
    }
