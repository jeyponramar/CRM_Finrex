...
public partial class EssentialReading_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_essentialreading", "essentialreadingid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Essential Reading";
        }
        else
        {
            lblPageTitle.Text = "Edit Essential Reading";
        }
