...
public partial class EnquiryFor_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_enquiryfor", "enquiryforid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Enquiry For";
        }
        else
        {
            lblPageTitle.Text = "Edit Enquiry For";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/EnquiryFor/view.aspx");
		}
    }
