...
public partial class ScheduleReminderConfig_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_schedulereminderconfig", "schedulereminderconfigid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Schedule Reminder Config";
        }
        else
        {
            lblPageTitle.Text = "Edit Schedule Reminder Config";
        }
	...
	private void PopulateSubGrid()
	{
		...
		sgrid.Populate(gblData, ltschedulereminderdetail, schedulereminderdetail_param, schedulereminderdetail_setting);
	}
			//PopulateSubGrid_END
    ...
    private int SaveData(bool isclose)
    {
        ...
        if (id > 0)
        {
			...
			gblData.SaveSubTable(id, gblData, schedulereminderdetail_setting);
			//SaveSubTable_END
            //SaveFile_START
			//SaveFile_END
