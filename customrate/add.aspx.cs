...
public partial class CustomRate_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_customrate", "customrateid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Custom Rate";
        }
        else
        {
            lblPageTitle.Text = "Edit Custom Rate";
        }
