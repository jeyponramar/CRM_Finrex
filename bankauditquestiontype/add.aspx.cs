...
public partial class BankAuditQuestionType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditquestiontype", "bankauditquestiontypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Question Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Question Type";
        }
