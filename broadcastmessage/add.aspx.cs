...
public partial class BroadcastMessage_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_broadcastmessage", "broadcastmessageid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Broadcast Message";
        }
        else
        {
            lblPageTitle.Text = "Edit Broadcast Message";
        }
