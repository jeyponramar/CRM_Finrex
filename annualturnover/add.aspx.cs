...
public partial class AnnualTurnover_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_annualturnover", "annualturnoverid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Annual Turnover";
        }
        else
        {
            lblPageTitle.Text = "Edit Annual Turnover";
        }
