...
public partial class PaymentMode_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_paymentmode", "paymentmodeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Payment Mode";
        }
        else
        {
            lblPageTitle.Text = "Edit Payment Mode";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/PaymentMode/view.aspx");
		}
    }
