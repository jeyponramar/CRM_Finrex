...
public partial class BankAuditBank_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditbank", "bankauditbankid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Bank";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Bank";
        }
