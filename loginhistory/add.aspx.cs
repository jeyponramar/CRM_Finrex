...
public partial class LoginHistory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_loginhistory", "loginhistoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Login History";
        }
        else
        {
            lblPageTitle.Text = "Edit Login History";
        }
