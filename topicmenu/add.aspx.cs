...
public partial class TopicMenu_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_topicmenu", "topicmenuid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Topic Menu";
        }
        else
        {
            lblPageTitle.Text = "Edit Topic Menu";
        }
