...
public partial class BankAuditDocumentCategory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditdocumentcategory", "bankauditdocumentcategoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Document Category";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Document Category";
        }
