...
public partial class BankBookingAccessMaster_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankbookingaccessmaster", "bankbookingaccessmasterid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Booking Access Master";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Booking Access Master";
        }
