 ...
 CodeFile="add.aspx.cs" Inherits="PaymentVoucher_Add" EnableEventValidation="false" ValidateRequest="false"%>
					...
					<tr>
						...
						<asp:RequiredFieldValidator ID="rfv1" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Required Ledger" ValidationGroup="vg" ControlToValidate="ledger"></asp:RequiredFieldValidator></td>
									...
									<td width='50%' class='valign'>
										...
										<tr>
											<td class="label">Amount Paid <span class="error">*</span></td>
											<td ti='0'><asp:TextBox ID="txtdramount"  dcn="ledgervoucher_dramount" runat="server" MaxLength="15" CssClass="textbox val-dbl" Text="0"></asp:TextBox>
						<asp:RequiredFieldValidator ID="rfv5" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Required Amount Paid" ValidationGroup="vg" ControlToValidate="txtdramount"></asp:RequiredFieldValidator></td>
										</tr>
										<tr>
