...
public partial class ReminderMonthType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_remindermonthtype", "remindermonthtypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Reminder Month Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Reminder Month Type";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if(SaveData(false) > 0)
        {
			Response.Redirect("~/ReminderMonthType/view.aspx");
		}
    }
