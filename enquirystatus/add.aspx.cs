...
public partial class EnquiryStatus_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_enquirystatus", "enquirystatusid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Enquiry Status";
        }
        else
        {
            lblPageTitle.Text = "Edit Enquiry Status";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/EnquiryStatus/view.aspx");
		}
    }
