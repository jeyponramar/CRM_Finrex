...
public partial class KYCBusinessPaymentCycle_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_kycbusinesspaymentcycle", "kycbusinesspaymentcycleid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add KYC Business Payment Cycle";
        }
        else
        {
            lblPageTitle.Text = "Edit KYC Business Payment Cycle";
        }
