...
public partial class MCLRBank_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_mclrbank", "mclrbankid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add MCLR Bank";
        }
        else
        {
            lblPageTitle.Text = "Edit MCLR Bank";
        }
