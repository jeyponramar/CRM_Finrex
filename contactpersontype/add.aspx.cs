...
public partial class ContactPersonType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_contactpersontype", "contactpersontypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Contact Person Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Contact Person Type";
        }
