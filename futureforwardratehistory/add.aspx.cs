...
public partial class FutureForwardrateHistory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_futureforwardratehistory", "futureforwardratehistoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Future Forwardrate History";
        }
        else
        {
            lblPageTitle.Text = "Edit Future Forwardrate History";
        }
	...
	private void PopulateSubGrid()
	{
		...
		sgrid.Populate(gblData, ltfutureforwardrate, futureforwardrate_param, futureforwardrate_setting);
	}
			//PopulateSubGrid_END
    ...
    private int SaveData(bool isclose)
    {
        ...
        if (id > 0)
        {
			...
			gblData.SaveSubTable(id, gblData, futureforwardrate_setting);
			//SaveSubTable_END
            //SaveFile_START
			//SaveFile_END
