...
public partial class QueryTopic_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_querytopic", "querytopicid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Query Topic";
        }
        else
        {
            lblPageTitle.Text = "Edit Query Topic";
        }
