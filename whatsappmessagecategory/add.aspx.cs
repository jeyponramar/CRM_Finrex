...
public partial class WhatsAppMessageCategory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_whatsappmessagecategory", "whatsappmessagecategoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add WhatsApp Message Category";
        }
        else
        {
            lblPageTitle.Text = "Edit WhatsApp Message Category";
        }
