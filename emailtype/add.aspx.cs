...
public partial class EmailType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_emailtype", "emailtypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Email Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Email Type";
        }
