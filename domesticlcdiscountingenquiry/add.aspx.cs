...
public partial class DomesticLCDiscountingEnquiry_add : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Domestic LC Discounting Enquiry";
        }
        else
        {
            lblPageTitle.Text = "Edit Domestic LC Discounting Enquiry";
        }
