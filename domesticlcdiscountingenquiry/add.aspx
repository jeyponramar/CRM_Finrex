 ...
 CodeFile="add.aspx.cs" Inherits="DomesticLCDiscountingEnquiry_add" EnableEventValidation="false" ValidateRequest="false"%>
						...
						<asp:RequiredFieldValidator ID="rfv8" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Required Beneficiary Name (Supplier)" ValidationGroup="vg" ControlToValidate="txtbeneficiarynamesupplier"></asp:RequiredFieldValidator></td>
									...
									<td width='50%' class='valign'>
										...
										<tr>
											...
											<td ti='1'><asp:TextBox ID="txttransactionamountwithcurrency"  dcn="domesticlcdiscountingenquiry_transactionamountwithcurrency" runat="server" MaxLength="15" CssClass="mbox val-dbl" Text="0"></asp:TextBox>
