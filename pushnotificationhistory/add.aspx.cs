...
public partial class PushNotificationHistory_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_pushnotificationhistory", "pushnotificationhistoryid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Push Notification History";
        }
        else
        {
            lblPageTitle.Text = "Edit Push Notification History";
        }
