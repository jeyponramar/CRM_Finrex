...
public partial class TermsAndConditionType_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_termsandconditiontype", "termsandconditiontypeid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Terms And Condition Type";
        }
        else
        {
            lblPageTitle.Text = "Edit Terms And Condition Type";
        }
    ...
    protected void btnSaveAndView_Click(object sender, EventArgs e)
    {
        if (SaveData(false) > 0)
		{
        	Response.Redirect("~/TermsAndConditionType/view.aspx");
		}
    }
