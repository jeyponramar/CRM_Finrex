...
public partial class MasterDirection_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_masterdirection", "masterdirectionid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Master Direction";
        }
        else
        {
            lblPageTitle.Text = "Edit Master Direction";
        }
