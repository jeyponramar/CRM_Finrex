...
public partial class Business_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_business", "businessid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Business";
        }
        else
        {
            lblPageTitle.Text = "Edit Business";
        }
