...
public partial class BankAuditConversionMargin_add : System.Web.UI.Page
{
    GlobalData gblData = new GlobalData("tbl_bankauditconversionmargin", "bankauditconversionmarginid");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Request.QueryString["id"] == null)
        {
            lblPageTitle.Text = "Add Bank Audit Conversion Margin";
        }
        else
        {
            lblPageTitle.Text = "Edit Bank Audit Conversion Margin";
        }
